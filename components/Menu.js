        ...
        return (
            <View style={styles.menuContainer}>
                <Animated.View style={{
                    ...
                    <TouchableOpacity style={styles.menuEntry} onPress={() => navigate("Preferences")}>
                        <Icon name="cogs" size={40}/>
                        <Text>Paramètres</Text>
                    </TouchableOpacity>
                    <TouchableOpacity style={styles.menuEntry} onPress={() => navigate("CostOfLiving")}>
                        <Image
                    ...
                    <TouchableOpacity style={styles.menuEntry} onPress={() => navigate("Translateur")}>
                        <Image
                ...
                <TouchableOpacity style={styles.floatButton} activeOpacity={0.7} onPress={()=>this.toggleMenu()}>
